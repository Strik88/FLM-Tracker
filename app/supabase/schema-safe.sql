...
drop policy if exists "metascripts_select_own" on public.metascripts;
drop policy if exists "metascripts_insert_own" on public.metascripts;
drop policy if exists "metascripts_update_own" on public.metascripts;
drop policy if exists "metascripts_delete_own" on public.metascripts;
...
drop policy if exists "scopes_insert_own" on public.scopes;
drop policy if exists "scopes_update_own" on public.scopes;
drop policy if exists "scopes_delete_own" on public.scopes;
